...
void NewProcess(const ProcessParams& params)
{
	...
	else
	{
		...
		if (strAppName.find("BE") != std::string::npos) system("net stop BEService"); // we could check in args what kind of anticheat it is but imo this is better.
		else if (strAppName.find("EAC") != std::string::npos) system("net stop EasyAnticheat");
...
int main(int argc, char** argv)
{
	...
	if (strAppName.find("BE") != std::string::npos) system("net start BEService"); // we could check in args what kind of anticheat it is but imo this is better.
	else if (strAppName.find("EAC") != std::string::npos) system("net start EasyAnticheat");
	else std::cout << "Major issue. Please send this to Milxnor: " << (fs::current_path() / strAppName).string() << std::endl;
